...
{
    public abstract class OnlineAuctionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OnlineAuctionWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OnlineAuctionWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OnlineAuctionDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OnlineAuctionDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OnlineAuctionDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OnlineAuctionDbContext, Task<T>> func)
        {
            T result;
